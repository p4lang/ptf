...
PPATH="/home/runner/.local/lib/python3.12/site-packages"

sudo PATH=${PATH} PYTHONPATH=${PPATH} python ptf_nn/ptf_nn_agent.py \
...
sudo PATH=${PATH} PYTHONPATH=${PPATH} python ptf_nn/ptf_nn_test_bridge.py -ifrom veth1 -ito veth2 \
    &
